...
```bash
python3 scripts/build_comparison_table.py --files examples/example_1.ndax examples/example_2.ndax --y-column Voltage --anchor-x 0.5 1.0
```
...
```bash
python3 scripts/build_comparison_table.py --files FILE1.ndax [FILE2.ndax ...] --y-column COLUMN --anchor-x NUMBER [NUMBER ...] [другие флаги]
```

Windows:

```bash
py scripts\build_comparison_table.py --files FILE1.ndax [FILE2.ndax ...] --y-column COLUMN --anchor-x NUMBER [NUMBER ...] [другие флаги]
```
