...
EXTREMA_COLUMNS: tuple[str, ...] = ("+U_l", "+U_m", "+U_r", "-U_l", "-U_m", "-U_r")
COMPARISON_TABLE_COLUMNS: tuple[str, ...] = ("name", *EXTREMA_COLUMNS)
...
def build_comparison_row(
    *,
    ...
    for extrema_label in EXTREMA_COLUMNS:
        ...
        row[extrema_label] = "" if extrema_position is None else y_series.iloc[extrema_position]
    return row
